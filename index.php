<?php include "header_head.php"; ?>
    ...
    <title>BIM Mekanik</title>
<?php include "header_nav.php"; ?>
<section id="intro">
    <div id="rev_slider_31_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="demo_minimalistic_portfolio" data-source="gallery" style="margin:0px auto;background:transparent;padding:0px;margin-top:0px;margin-bottom:0px;">
        <div id="rev_slider_31_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.8.1">
            <ul>
                <li data-index="rs-85" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="800" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <div class="rs-background-video-layer" data-volume="mute" data-ytid="2Br5eiQnLOk" data-videoattributes="version=3&amp;enablejsapi=1&amp;html5=1&amp;hd=1&amp;wmode=opaque&amp;showinfo=0&amp;rel=0;" data-videorate="1" data-videowidth="100%" data-videoheight="100%" data-videocontrols="none" data-videoloop="none" data-aspectratio="16:9" data-autoplay="true" data-autoplayonlyfirsttime="false" data-nextslideatend="true"></div>
 ...
 <div>
				...
				<div class="pt-100 pb-100 top-triangle bg__style lazyload" data-bg="bk.png">
					<div class="brk-layer position-absolute brk-base-bg-14"></div>
					<div class="container all-light brk-z-index-10 position-relative">
						<h3 class="font__family-montserrat font__weight-semibold font__size-30 line__height-46 text-uppercase letter-spacing-100 text-center">
							BIM Mekanik <br></h3>
							<p class="font__family-open-sans font__size-16 mt-20 text-center">Mimari projeler BIM tabanlı degil ise, mevcut dökümanları kullanarak BIM ortamına kendim aktarıyor, çalısmalarımı BIM tabanlı sürdürüyorum.</p>
							<div class="row justify-content-center mt-40">
								<div class="col-md-6 col-lg-4">
									<div class="info-box__wrapper-icon text-center" data-brk-library="component__info_box">
										<div class="wow fadeInDown" data-wow-duration="0.8s" data-wow-delay="0s">
										...
										<div class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0s">
											<h6 class="font__family-montserrat font__weight-semibold font__size-18 line__height-28">TASARIM </h6>
												<ul>
                                                    ...
                                                    <li>
                                                        <p>ISI YALITIM HESAP RAPORLARI	</p>
                                                    </li>
                                                    <li>
                                                        <p>MEKANIK TESISAT SISTEM SEÇIMI</p>
                                                    </li>
                                                    <li>
                                                        <p>CIHAZ KAPASITE HESAPLARI	</p>
                                                    </li>
                                                    <li>
                                                        <p>BIM TABANLI 3D MODELLEME</p>
                                                    </li>
                                                    <li>
								...
								<div class="col-md-6 col-lg-4">
									<div class="info-box__wrapper-icon text-center" data-brk-library="component__info_box">
										<div class="wow fadeInDown" data-wow-duration="0.8s" data-wow-delay="0.2s">
											<i class="fas fa-dice-d6"></i>
										</div>
										<div class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">
                                            ...
                                            <ul>
                                                    ...
                                                    <li>
                                                        <p>4D SiMULASYON (+ZAMAN BOYUTU)</p>
                                                    </li>
                                                    <li>
